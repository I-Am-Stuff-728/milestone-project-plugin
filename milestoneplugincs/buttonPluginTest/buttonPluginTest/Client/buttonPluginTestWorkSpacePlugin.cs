...
{
    public class buttonPluginTestWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return buttonPluginTestDefinition.buttonPluginTestWorkSpacePluginId; }
        }
        ...
        public override void Init()
        {
         ...
         //   rectangles.Add(new Rectangle(000, 200, 1000, 800));     // Index 2
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(1, new buttonPluginTestWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
