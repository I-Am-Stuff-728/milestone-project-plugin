...
namespace buttonPluginTest.Background
{
    /// <summary>
    ...
    /// </summary>
    public class buttonPluginTestBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return buttonPluginTestDefinition.buttonPluginTestBackgroundPlugin; }
        }
        ...
        {
            get { return "buttonPluginTest BackgroundPlugin"; }
        }
        ...
        public override void Init()
        {
            ...
            _thread.Name = "buttonPluginTest Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "buttonPluginTest background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "buttonPluginTest background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}
