...
namespace buttonPluginTest.Client
{
    ...
    /// </summary>
    public class buttonPluginTestViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public buttonPluginTestViewItemManager() : base("buttonPluginTestViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(buttonPluginTestDefinition.buttonPluginTestPluginId, null, buttonPluginTestDefinition.buttonPluginTestKind);
        ...
        //{
        //	return new buttonPluginTestViewItemUserControl(this);
        //}
        ...
        {
            return new buttonPluginTestViewItemWpfUserControl(this);
        }
        ...
        //{
        //	return new buttonPluginTestPropertiesUserControl(this);
        //}
        ...
        {
            return new buttonPluginTestPropertiesWpfUserControl(this);
        }
