...
{
    public partial class buttonPluginTestTabUserControl : VideoOS.Platform.Admin.TabUserControl
    {
        private Item _associatedItem;
        private bool _ignoreChanged = false;
        private AssociatedProperties _associatedProperties;

        public buttonPluginTestTabUserControl(Item item)
        {
            InitializeComponent();
        ...
        public override void Init()
        {
            ...
            _associatedProperties = Configuration.Instance.GetAssociatedProperties(_associatedItem, buttonPluginTestDefinition.buttonPluginTestTabPluginId);
