...
namespace buttonPluginTest.Client
{
    ...
    /// </summary>
    public partial class buttonPluginTestViewItemWpfUserControl : ViewItemWpfUserControl
    {
        #region Component private class variables

        private buttonPluginTestViewItemManager _viewItemManager;
        ...
        /// <summary>
		/// Constructs a buttonPluginTestViewItemUserControl instance
        /// </summary>
		public buttonPluginTestViewItemWpfUserControl(buttonPluginTestViewItemManager viewItemManager)
        {
