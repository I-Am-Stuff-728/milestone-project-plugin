...
{
    public class buttonPluginTestSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return buttonPluginTestDefinition.buttonPluginTestSettingsPanel; }
        }
        ...
        {
            _userControl = new buttonPluginTestSettingsPanelControl(this);
            return _userControl;
        }
