...
namespace buttonPluginTest.Admin
{
    ...
    /// </summary>
    public class buttonPluginTestItemManager : ItemManager
    {
        private buttonPluginTestUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public buttonPluginTestItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new buttonPluginTestUserControl();
        ...
        {
            return new buttonPluginTestAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(buttonPluginTestDefinition.buttonPluginTestPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((buttonPluginTestAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(buttonPluginTestDefinition.buttonPluginTestPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(buttonPluginTestDefinition.buttonPluginTestPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(buttonPluginTestDefinition.buttonPluginTestPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(buttonPluginTestDefinition.buttonPluginTestPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(buttonPluginTestDefinition.buttonPluginTestPluginId, _kind, fqid.ObjectId);
            return item;
        }
