...
namespace buttonPluginTest.Client
{
    ...
    /// </summary>
    public class buttonPluginTestViewItemPlugin : ViewItemPlugin
    {

        public buttonPluginTestViewItemPlugin()
        {
        }
        ...
        {
            get { return buttonPluginTestDefinition.buttonPluginTestViewItemPlugin; }
        }
        ...
        {
            return new buttonPluginTestViewItemManager();
        }
