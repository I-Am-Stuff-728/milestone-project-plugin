...
namespace buttonPluginTest.Client
{
    ...
    /// </summary>
    public class buttonPluginTestSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new buttonPluginTestSidePanelUserControl();
        //}
        ...
        {
            return new buttonPluginTestSidePanelWpfUserControl();
        }
        ...
        {
            get { return buttonPluginTestDefinition.buttonPluginTestSidePanel; }
        }
