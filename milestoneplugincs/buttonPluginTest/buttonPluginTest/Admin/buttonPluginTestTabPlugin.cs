...
{
    public class buttonPluginTestTabPlugin : TabPlugin
    {
        ...
        {
            get { return buttonPluginTestDefinition.buttonPluginTestTabPluginId; }
        }

        public override Image Icon
        {
            get { return buttonPluginTestDefinition.TreeNodeImage; }
        }
        ...
        public override TabUserControl GenerateUserControl(Item item)
        {
            ...
            return new buttonPluginTestTabUserControl(item);
        }
